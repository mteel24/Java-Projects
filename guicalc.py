...
button_equal = Button(root,text="=", padx=88, pady=20, command=lambda: buttonEqual())
button_clear = Button(root,text="Clear", padx=79, pady=20, command=lambda: buttonClear())
button_sub = Button(root,text="-", padx=39, pady=20, command=lambda: buttonSubtract())
button_mult = Button(root,text="*", padx=39, pady=20, command=lambda: buttonMultiple())
button_divide = Button(root,text="/", padx=39, pady=20, command=lambda: buttonDivide())
